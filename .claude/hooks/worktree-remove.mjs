...
// Only ever recursive-delete a path that actually looks like one of our
// worktrees. `git worktree remove` above may have failed precisely because
// this was never a worktree — deleting it anyway would be catastrophic.
const isManagedWorktree = /[/\\]\.claude[/\\]worktrees[/\\][^/\\]+$/.test(
  path.resolve(wtPath),
);
