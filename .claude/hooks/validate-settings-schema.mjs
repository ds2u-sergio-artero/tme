 ...
 *   SETTINGS_SCHEMA_URL   — default: https://json.schemastore.org/claude-code-settings.json
...
const SCHEMA_URL =
  process.env.SETTINGS_SCHEMA_URL ?? "https://json.schemastore.org/claude-code-settings.json";
